<template>
  <div class="ma-2" height="100%">
    <v-col cols="12" sm="12" md="6" offset-md="3" height="100%">
      <v-card
        fill-height
      ...
      >
        <v-card color="transparent" dark>
          <v-card-text class="text-h4 grey-transparent">Privacy Policy</v-card-text>
        </v-card>

        <v-card color="transparent">
          <v-card-text class="mt-4 text-h5 pa-3 white-transparent" flat shaped>
            <p>
              Abcdevelop built the SimpleBreath app as
              a Free app. This Service is provided by
              Abcdevelop at no cost and is intended for use as
              is.
            </p> <p>
              ...
              SimpleBreath unless otherwise defined in this Privacy Policy.
